...
def objective(trial, stride=40):
    ...
    gb_n_estimators = trial.suggest_int("n_estimators", 2, 30)
    gb_max_depth = trial.suggest_int("max_depth", 2, 30)
    gb_min_samples_leaf = trial.suggest_int("min_samples_leaf", 5, 40)
    gb_learning_rate = trial.suggest_float("learning_rate", 0.01, 0.1)
    gb_subsample = trial.suggest_float("subsample", 0.5, 1.0)
